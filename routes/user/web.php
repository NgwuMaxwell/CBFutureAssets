...
Route::middleware(['auth:sanctum', 'verified'])->prefix('dashboard')->group(function () {
    ...
    Route::middleware('complete.kyc')->group(function () {
        ...
        //nft route
        Route::get('/nfts/index', [UserNFTController::class, 'create'])->name('user.nfts.index');
...
Route::get('/singalssubscriptions', [UserSubscriptionController::class, 'index'])->name('user.signal.index');
 ...
 //buy
       ...
       Route::post('/nfts/{nft}/sell', [UserNFTController::class, 'sellNFT'])->name('user.nfts.sell');
        ...
        Route::post('copy-trading/start/{expert}', [CopyTradingController::class, 'startCopying'])->name('startCopying');
        Route::post('copy-trading/stop/{expert}', [CopyTradingController::class, 'stopCopying'])->name('stopCopying');
