...
Route::prefix('admin')->group(function () {
    Route::controller(LoginController::class)->group(function () {
        Route::get('login', 'showLoginForm')->name('admin.login')->middleware('adminguest');
...
Route::middleware(['isadmin', '2fa'])->prefix('admin')->group(function () {
    ...
    Route::controller(TradingPaymentController::class)->group(function () {
...
//signals
    ...
    Route::get('/admin/nfts/sold', [NftController::class, 'soldNFTs'])->name('admin.nfts.sold');
    ...
    Route::put('/admin/loans/{loan}/approve', [LoanController::class, 'approve'])->name('loans.approve');
    Route::put('/admin/loans/{loan}/reject', [LoanController::class, 'reject'])->name('loans.reject');
   ...
   Route::post('/admin/bids/{bid}/approve', [AdminBidController::class, 'approveBid'])->name('admin.bids.approve');
    ...
    // Ensure only admins can access
       ...
       if (config('session.driver') === 'database') {
        ...
        return "Cache and session cleared successfully!";
