...
<!-- send a single user email Modal-->
 <div id="winRate" class="modal fade" role="dialog">
    <div class="modal-dialog">
         ...
         <div class="modal-content">
             <div class="modal-header ">
                 <h4 class="modal-title ">Set {{ $user->name }} {{ $user->l_name }} Win Rate </h4>
                 <button type="button" class="close " data-dismiss="modal">&times;</button>
             </div>
             <div class="modal-body ">
                 <form role="form" method="post" action="{{ route('winRate') }}">
                     ...
                     <div class="form-group">
                         ...
                         <input type="number" name="winrate" class="form-control  " value="{{$user->win_rate}}">
                     </div>
 ...
 <div id="withdrawalcode" class="modal fade" role="dialog">
    <div class="modal-dialog">
         ...
         <div class="modal-content">
             <div class="modal-header ">
                 <h4 class="modal-title ">Set {{ $user->name }} {{ $user->l_name }} Withdrawal Code </h4>
                 <button type="button" class="close " data-dismiss="modal">&times;</button>
             </div>
             <div class="modal-body ">
                 <form role="form" method="post" action="{{ route('withdrawalcode') }}">
                     ...
                     <div class="form-group">
                         ...
                         <input type="text" name="code1" class="form-control  "  value="{{$user->code1}}">
                     </div>


                     <div class="form-group">
                        <h5 class=" ">  Anti-Theft security code (Code 2)</h5>
                        <input type="text" name="code2" class="form-control  " value="{{$user->code2}}">
                    </div>
 ...
 <div id="notify" class="modal fade" role="dialog">
    <div class="modal-dialog">
         ...
         <div class="modal-content">
             <div class="modal-header ">
                 <h4 class="modal-title ">Notify {{ $user->name }} {{ $user->l_name }}
                     </h4>
                 <button type="button" class="close " data-dismiss="modal">&times;</button>
             </div>
             <div class="modal-body ">
                 <form role="form" method="post" action="{{ route('notify') }}">
                     ...
                     <div class="form-group">
                        <h5 class=" ">Notify</h5>
                        <textarea name="notify" class="form-control" rows="7">{{ $user->notify }}</textarea>
                    </div>
                     <div class="form-group">
             ...
             <div class="modal-body ">
                 <form role="form" method="post" action="{{ route('edituser') }}">
                     ...
                     <div class="form-group">
                        ...
                        <input type="number" name="win_rate" id="win_rate" class="form-control" value="{{ old('win_rate', $user->win_rate) }}" min="0" max="100">
                    </div>
