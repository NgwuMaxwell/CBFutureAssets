...
<main>
                            ...
                            <div class="row gx-md-5 align-items-md-center">
                                ...
                                <div class="col-md-4 col-xl-6 order-last">
                                    <div class="in-carousel-image">
                                        <img
                                            src="{{ asset('temp/frontpage/img/in-cirro-slide-1.jpg')}}"
                                            alt="slide"
                                            width="856"
                                            height="570" />
                                    </div>
                        ...
                        <div class="container">
                            <div class="row gx-md-5 align-items-md-center">
                                ...
                                <div class="col-md-4 col-xl-6 order-last">
                                    <div class="in-carousel-image">
                                        <img
                                            src="{{ asset('temp/frontpage/img/in-cirro-slide-2.jpg')}}"
                                            alt="slide"
                                            width="856"
                                            height="570" />
                                    </div>
                        ...
                        <div class="container">
                            <div class="row gx-md-5 align-items-md-center">
                                ...
                                <div class="col-md-4 col-xl-6 order-last">
                                    <div class="in-carousel-image">
                                        <img
                                            src="{{ asset('temp/frontpage/img/in-cirro-slide-3.jpg')}}"
                                            alt="slide"
                                            width="856"
                                            height="570" />
                                    </div>
                    ...
                    <div
                        ...
                        <div class="col">
                            <div class="ticker-image d-flex align-items-center">
                                <img
                                    class="opacity-75"
                                    src="{{ asset('temp/frontpage/img/in-cirro-1-ticker-1.svg')}}"
                                    alt="ticker-logo"
                                    width="138"
                                    height="34" />
                            </div>
                        ...
                        <div class="col">
                            <div class="ticker-image d-flex align-items-center">
                                <img
                                    class="opacity-75"
                                    src="{{ asset('temp/frontpage/img/in-cirro-1-ticker-2.svg')}}"
                                    alt="ticker-logo"
                                    width="139"
                                    height="35" />
                            </div>
                        ...
                        <div class="col">
                            <div class="ticker-image d-flex align-items-center">
                                <img
                                    class="opacity-75"
                                    src="{{ asset('temp/frontpage/img/in-cirro-1-ticker-3.svg')}}"
                                    alt="ticker-logo"
                                    width="135"
                                    height="27" />
                            </div>
                        ...
                        <div class="col">
                            <div class="ticker-image d-flex align-items-center">
                                <img
                                    class="opacity-75"
                                    src="{{ asset('temp/frontpage/img/in-cirro-1-ticker-4.svg')}}"
                                    alt="ticker-logo"
                                    width="130"
                                    height="20" />
                            </div>
                        ...
                        <div class="col d-none d-lg-block">
                            <div class="ticker-image d-flex align-items-center">
                                <img
                                    class="opacity-75"
                                    src="{{ asset('temp/frontpage/img/in-cirro-1-ticker-5.svg')}}"
                                    alt="ticker-logo"
                                    width="137"
                                    height="32" />
                            </div>
                        ...
                        <div class="col d-none d-lg-block">
                            <div class="ticker-image d-flex align-items-center">
                                <img
                                    class="opacity-75"
                                    src="{{ asset('temp/frontpage/img/in-cirro-1-ticker-6.svg')}}"
                                    alt="ticker-logo"
                                    width="114"
                                    height="31" />
                            </div>
            ...
            <div
                ...
                <div class="col d-flex align-items-stretch">
                    <div class="card">
                        <div class="card-body">
                            <img
                                src="{{ asset('temp/frontpage/img/in-cirro-2-icon-1.svg')}}"
                                alt="icon"
                                width="46"
                                height="46" />
                ...
                <div class="col d-flex align-items-stretch">
                    <div class="card">
                        <div class="card-body">
                            <img
                                src="{{ asset('temp/frontpage/img/in-cirro-2-icon-2.svg')}}"
                                alt="icon"
                                width="46"
                                height="46" />
                ...
                <div class="col d-flex align-items-stretch">
                    <div class="card">
                        <div class="card-body">
                            <img
                                src="{{ asset('temp/frontpage/img/in-cirro-2-icon-3.svg')}}"
                                alt="icon"
                                width="46"
                                height="46" />
                ...
                <div class="col d-flex align-items-stretch">
                    <div class="card">
                        <div class="card-body">
                            <img
                                src="{{ asset('temp/frontpage/img/in-cirro-2-icon-4.svg')}}"
                                alt="icon"
                                width="46"
                                height="46" />
                            <h2 class="h5 mt-4">Low Commissions</h2>
                            <p>
                                {{$settings->site_name}} now offers $0 commission on Gold trades,
    ...
    {{-- <iframe
        ...
        src="{{ asset('temp/frontpage/form/with.html')}}"
        frameborder="0"
        border="0"
        cellspacing="0"
    ...
    <section class="py-5 in-cirro-17">
        <div class="container position-relative">
            <img
                ...
                src="{{ asset('temp/frontpage/img/WBIG-Performance-Oct-2022.png')}}"
                alt="headquarters"
                width="540"
                height="513" />
            <div class="row">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="mb-1">
                                        Precious metals are a fast-moving global market. {{$settings->site_name}} lets you trade price movements on highly-traded
        ...
        <div class="col-12">
            <p class="text-muted">
                ...
                <span class="small">Trading derivatives and leveraged products carries a high level
                    ...
                    <a class="text-decoration-none" href="{{route('register')}}">Join now!</a></span>
            </p>
        </div>
    </div>
                    ...
                    <div class="card card-body">
                        <div
                            ...
                            <div class="col-md-5 col-lg-6">
                                <img
                                    class="testi-image"
                                    src="{{ asset('temp/frontpage/img/in-cirro-4-people-.png')}}"
                                    alt="testimonial"
                                    width="418"
                                    height="441" />
                            </div>
                        ...
                        <div class="row row-cols-1 row-cols-md-4 row-cols-lg-4 gx-0">
                            <div class="col text-center">
                                <img
                                    ...
                                    src="{{ asset('temp/frontpage/img/blockit/logo-jumio - Copy.svg')}}"
                                    alt="press-logo"
                                    width="128"
                                    height="21" />
                            </div>
                            <div class="col text-center">
                                <img
                                    class="opacity-75 my-2 my-md-1 my-lg-1"
                                    src="{{ asset('temp/frontpage/img/blockit/logo-aws.svg')}}"
                                    alt="press-logo"
                                    width="128"
                                    height="23" />
                            </div>
                            <div class="col text-center">
                                <img
                                    class="opacity-75 my-2 my-md-1 my-lg-1"
                                    src="{{ asset('temp/frontpage/img/blockit/logo-cloudflare - Copy.svg')}}"
                                    alt="press-logo"
                                    width="127"
                                    height="24" />
                            </div>
                            <div class="col text-center">
                                <img
                                    class="opacity-75 my-2 my-md-1 my-lg-1"
                                    src="{{ asset('temp/frontpage/img/blockit/logo-ledger.svg')}}"
                                    alt="press-logo"
                                    width="126"
                                    height="30" />
                            </div>
                ...
                <div class="col-md-12 col-lg-10">
                    <div class="row d-flex align-items-start">
                        <div class="col-md-5 col-lg-6 order-last order-md-first">
                            <img
                                class="w-100"
                                src="{{ asset('temp/frontpage/img/in-cirro-10-mockup.png')}}"
                                alt="mockup" />
                        </div>
                        <div class="col-md-7 col-lg-6 pb-5 order-first order-md-last">
                            ...
                            <a href="/#"><img
                                    src="{{ asset('temp/frontpage/img/in-app-button-apple.svg')}}"
                                    alt="apple"
                                    width="120"
                                    height="40" /></a>
                            <a href="/#" class="ms-1"><img
                                    src="{{ asset('temp/frontpage/img/in-app-button-google.svg')}}"
                                    alt="google"
                                    width="135"
                                    height="40" /></a>
                        </div>
        ...
        <div class="container">
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 gy-3 gy-lg-0">
                <div class="col d-flex align-items-center">
                    <img
                        src="{{ asset('temp/frontpage/img/in-cirro-11-award.svg')}}"
                        alt="award"
                        width="54"
                        height="50" />
                    <div class="ms-2">
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-8">
                    ...
                    <p>
                        ...
                        <a href="/#" class="link-primary text-decoration-none"><i class="fab fa-twitter"></i><small>@ {{$settings->site_name}}</small></a>
                    </p>
                </div>
            </div>
            <hr class="mt-3 mb-2" />
                ...
                <div class="col timeline-horizontal">
                    <div class="timeline-item d-flex align-items-center ms-3">
                        ...
                        <div class="d-flex align-items-center">
                            <h5 class="fw-bold mb-0 me-1">{{$plan->name}}</h5>
                            <span class="badge bg-secondary">{{$settings->currency}}{{$plan->min_price}} - {{$settings->currency}}{{$plan->max_price}}</span>
                        </div>
                    </div>
                    <div class="card mt-2">
                        <div class="card-body ps-2">
                            <ul class="fa-ul lh-lg mb-0">
                                <li>
                                    <span class="fa-li"><i class="fas fa-check-square text-primary"></i></span>up to {{$plan->increment_amount}}%
                                </li>
                                <li>
                                    <span class="fa-li"><i class="fas fa-check-square text-primary"></i></span>Trading Interest on crypto
                                </li>
                                <li>
                                    <span class="fa-li"><i class="fas fa-check-square text-primary"></i></span>Ref Commission: {{$settings->currency}}{{$plan->gift}}
                                </li>
                                <li>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button
                                    ...
                                    aria-expanded="true">
                                    Is {{$settings->site_name}} a licensed broker?
                                </button>
                            </h2>
                            <div
                                id="a5One"
                                ...
                                <div class="accordion-body">
                                    <p>
                                        Yes, {{$settings->site_name}} is a trust broker, adhering
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button
                                    ...
                                    aria-expanded="false">
                                    What services does {{$settings->site_name}} offer?
                                </button>
                            </h2>
                            <div
                                id="a5Two"
                                ...
                                <div class="accordion-body">
                                    <p>
                                        {{$settings->site_name}} offers a range of services including forex
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button
                                    ...
                                    aria-expanded="false">
                                    How does {{$settings->site_name}} ensure the security of my
                                    investments?
                                </button>
                            </h2>
                            <div
                                ...
                                <div class="accordion-body">
                                    <p>
                                        {{$settings->site_name}} employs advanced security measures, such as
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button
                                    ...
                                    aria-expanded="false">
                                    Does {{$settings->site_name}} provide customer support?
                                </button>
                            </h2>
                            <div
                                id="a5Four"
                                ...
                                <div class="accordion-body">
                                    <p>
                                        Yes, {{$settings->site_name}} offers award-winning customer support
