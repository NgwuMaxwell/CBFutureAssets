            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <h1>{{ $settings->currency }}{{ number_format($amount) }}</h1>
                        </div>
                    </div>
                    <!-- Title -->
                    <h3 class="card-title mt-3 mb-0 text-dark">{{ $payment_mode->name }}</h3>
                    <span class="text-muted m-0 p-0">{{ $payment_mode->name }}</span>
                </div>
            </div>
        </div>
    </div>
                                ...
                                @if ($title != 'Complete Payment')
                                    ...
                                    <div>
                                       ...
                                       @if (!empty($payment_mode->barcode))
                                        ...
                                        <img src="{{ asset('storage/app/public/'.$payment_mode->barcode)}}" alt="" class="w-25">
                                  @endif
                                        </h4>
                                    </div>
                                                ...
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control readonly"
                                                            value="{{ $payment_mode->wallet_address }}" id="myInput"
                                                            readonly>
                                                        <div class="input-group-append">
                                                        <button class="btn btn-outline-success" onclick="myFunction()" type="button" id="button-addon2"><i class="fas fa-copy"></i></button>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="mb-3 input-group">
                                                            ...
                                                            <div class="input-group-append">
                                                                <button class="btn btn-outline-secondary"
                                                                    onclick="myFunction2()" type="button"
