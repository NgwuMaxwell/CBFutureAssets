...
<div class="row mgt5">
  ...
  <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-4">
    <div class="activity-block  success">
      <div class="media">
        <div class="media-body">
          <h5 class="font-weight-bold"><span class="">{{$settings->currency}}{{ number_format(Auth::user()->roi, 2, '.', ',')}}</span></h5>
          <p>Profit</p>
        </div>
  ...
  <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-4">
    <div class="activity-block  success">
      <div class="media">
        <div class="media-body">
          <h5 class="font-weight-bold"><span class="">{{$settings->currency}}{{ number_format(Auth::user()->bonus, 2, '.', ',')}}</span></h5>
          <p>Total Bonus</p>
        </div>
...
@keyframes blink {
  ...
  <div class="col-md-6 col-lg-6 col-xl-6">
    ...
    <span style="float:right;font-size:15px">Balance : <span style="color:green">{{$settings->currency}}{{ number_format(Auth::user()->account_bal, 2, '.', ',')}}</span></span>
      ...
      <form  id="tradeForm" action="{{ route('trades.store') }}" method="POST" class="p-3 text-white rounded">
                            @csrf
