                    ...
                    <div>
                        <form method="POST" action="<?php echo e(route('createuser')); ?>">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <h6 class="themes/purposeTheme/assets/">Referral Code (Optional)</h6>
                                    <input type="text" class="form-control  themes/purposeTheme/assets/"
                                        name="ref_by" wire:model.defer='ref_by' 
                                        placeholder="Enter referral code if applicable">
                                    <small class="text-muted">Leave blank if no referral</small>
                                </div>
                            </div>
