...
<div class="row  align-items-center justify-content-between" style="margin-top:10px">
  <div class="col-16 col-sm-16">
    <div class="btn-group pull-left">
        ...
        <a href="<?php echo e(route('user.signal.plans')); ?>" class="btn btn-success mx-4  my-2">Signals</a>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>$<?php echo e(number_format($subscription->plan->price, 2)); ?></td>
                                        <td><?php echo e(\Carbon\Carbon::parse($subscription->expires_at)->toDayDateTimeString()); ?></td>
...
<?php echo $__env->make('layouts.dash1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/complexanalysis/public_html/app.complexanalysis.sbs/resources/views/user/signals/subscriptions.blade.php ENDPATH**/ ?>