            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $loans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td><?php echo e($settings->currency); ?><?php echo e(number_format($loan->amount, 2)); ?></td>
                        <!--<td><?php echo e($loan->credit_facility); ?></td>-->
                        <td><?php echo e($loan->duration); ?></td>
                        <td><?php echo e($settings->currency); ?><?php echo e($loan->monthly_income); ?></td>
                        <!--<td><?php echo e($loan->purpose); ?></td>-->
                        <td>
                            <span class="badge
                                <?php echo e($loan->status == 'approved' ? 'badge-success' : ($loan->status == 'pending' ? 'badge-warning' : 'badge-danger')); ?>">
                                <?php echo e(ucfirst($loan->status)); ?>

                            </span>
                        </td>
                        <td><?php echo e($loan->created_at->format('Y-m-d H:i')); ?></td>
                    </tr>
...
<?php echo $__env->make('layouts.dash1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/complexanalysis/public_html/app.complexanalysis.sbs/resources/views/user/loans/my_loans.blade.php ENDPATH**/ ?>