      ...
      <div class="container mb-2">
        <div class="row  align-items-center p-2">
          ...
          <div class="col-sm-16 col-lg-4 col-xl-4  profile-name">
            <i style="color:#0f0;font-size:20px" class="fa fa-check-circle blink_me"> <?php echo e((Auth::user()->account_verify == 'Verified' || Auth::user()->email_verified_at) ? 'Verified' : 'Not Verified'); ?></i>            <h2><?php echo e(Auth::user()->name); ?></h2>
          ...
          <div class="col-md-4">
            <div class="card ">
              ...
              <label class="text-primary" for="">
                <i style="color:#0f0;font-size:20px" class="fa fa-check-circle blink_me">  <?php echo e((Auth::user()->account_verify == 'Verified' || Auth::user()->email_verified_at) ? 'Verified' : 'Not Verified'); ?></i>     </label>
