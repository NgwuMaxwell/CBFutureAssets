...
} elseif ($_instance->childHasBeenRendered('1EKjXgs')) {
    $componentId = $_instance->getRenderedChildComponentId('1EKjXgs');
    $componentTag = $_instance->getRenderedChildComponentTagName('1EKjXgs');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1EKjXgs');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('1EKjXgs', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
